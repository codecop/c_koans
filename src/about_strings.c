    ...
    */
    ...
    /*
        ...
        *(string + 1) adds 1 to the pointer then
        dereferences it
    */
    cr_assert_not_eq(*string + 1, *(string + 1), "They are not equal");
}
...
static void about_strings_sizeof_strlen(void** state)
{
    ...
    */
    ...
    cr_assert_not_eq(sizeof(string), strlen(string), "strlen ends counting at \\0");
...
static void about_strings_function_paramater(void** state)
{
    ...
    */
    char string[] = { 'C', 'S', 'E', 'E', '\0'};
    cr_assert_eq(4, strlen(string), "Sizeof gives correct output");
